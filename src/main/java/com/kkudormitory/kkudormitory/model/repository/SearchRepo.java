...
public class SearchRepo {
    ...
    public SearchRepo() throws SQLException, ClassNotFoundException {
    ...
    public List<Map<String, Object>> searchDorm(@PathVariable("search") String search) throws SQLException, ClassNotFoundException {
        PreparedStatement near = con.prepareStatement("SELECT d.dormID, d.dorm_name, d.address, d.month_price, GROUP_CONCAT(i.image_name) AS image_urls FROM dormitory d LEFT JOIN images i ON d.dormID = i.dormID WHERE d.dorm_name LINK ? GROUP BY d.dormID");
	    near.setString(1, "%"+search+"%");
